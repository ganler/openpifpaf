...
int main(int argc, char** argv) {
  ...
  const ai_app::Rect tileCoordinates { {4, 2}, {839, 604} };
  ai_app::Object_detection::Result res = pp.postprocess(
        inputWidth, inputHeight, featureWidth, featureHeight, tileCoordinates,
        pif, paf
  );
